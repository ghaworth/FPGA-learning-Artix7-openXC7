...
- Key design decisions:
  ...
  - **Distributed RAM** (`(* ram_style = "distributed" *)`) for the count array. Yosys BRAM inference (RAMB36E1) produces a deterministic wrong result (8,995 vs correct 231,229,866,702,355) on hardware, while simulation and distributed RAM both give the correct answer. WRITE_MODE was investigated and ruled out (FASM confirms READ_FIRST on every inferred block). Root cause is under active investigation.
